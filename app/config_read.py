...
def read(folder_path:str)->Config:
    ...
    wind_func = wind.wind_velocity_power(js["wind_reference_height"],js["wind_speed"],js["wind_exponent"],js["wind_direction"])
    return Config(mass_func,
                    wind_func,
                    thrust_func,
                    js["CA"],
                    js["CN_alpha"],
                    ...
                    js["dt"],
                    js["launcher_length"],
                    InertiaTensor(js["I_xx"],js["I_yy"],js["I_zz"],js["I_xy"],js["I_zy"],js["I_xz"]),
                    js["first_elevation"],
                    js["first_azimuth"],
                    js["first_roll"],
